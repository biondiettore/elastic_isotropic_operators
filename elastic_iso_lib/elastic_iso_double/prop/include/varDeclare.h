...
#define max2(v1,v2) (((v1)>(v2))?(v1):(v2)) /* Minimum function */
	...
	**dev_receiversPositionRegZGrid,**dev_receiversPositionRegXZGrid; // Array containing the positions of the receivers on the regular grid
	...
	double **dev_wavefieldDts_left, **dev_wavefieldDts_right, **dev_pStream, **dev_pStream_Vx, **dev_pStream_Vz; //Left, right, and temp time slices for saving the wavefield using streams
	double **pin_wavefieldSlice, **pin_wavefieldSlice_Vx, **pin_wavefieldSlice_Vz; //Pinnned memory to allow ansync memory copy
	...
	double **dev_wavefieldVx_left, **dev_wavefieldVx_right, **dev_wavefieldVz_left, **dev_wavefieldVz_right, **dev_wavefieldVx_cur, **dev_wavefieldVz_cur; //Vx and Vz wavefields slices for Streams
	...
	double **host_wavefieldVx, **host_wavefieldVz;
