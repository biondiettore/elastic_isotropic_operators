#ifndef SPACE_INTERP_GPU_H
#define SPACE_INTERP_GPU_H 1
...
*/
class spaceInterpGpu : public Operator<SEP::double2DReg, SEP::double2DReg> {

	private:

		/* Spatial interpolation */
		//std::shared_ptr<double2DReg> _elasticPar; /** for dimension checking*/
	...
	public:
		...
		spaceInterpGpu(const std::shared_ptr<double1DReg> zCoord, const std::shared_ptr<double1DReg> xCoord, const std::shared_ptr<SEP::hypercube> elasticParamHyper, int nt, std::string interpMethod="linear", int nFilt=4);
