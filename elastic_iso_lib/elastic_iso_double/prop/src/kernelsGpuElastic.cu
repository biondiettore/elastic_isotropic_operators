...
__global__ void ker_record_interp_source_centerGrid(double *dev_newTimeSlice_sigmaxx, double *dev_newTimeSlice_sigmazz, double *dev_signalOut_sigmaxx, double *dev_signalOut_sigmazz, int its, int it2, int *dev_sourcesPositionRegCenterGrid, int nSourcesRegCenterGrid) {
    int iThread = blockIdx.x * blockDim.x + threadIdx.x;
		if (iThread < nSourcesRegCenterGrid){
...
//STAGGERED GRIDs
__global__ void ker_record_interp_source_stagGrid(double *dev_newTimeSlice, double *dev_signalOut, int its, int it2, int *dev_sourcesPositionRegGrid, int nSourcesRegGrid) {
...
//Central grid
__global__ void ker_inject_interp_source_centerGrid(double *dev_signalIn_sigmaxx, double *dev_signalIn_sigmazz, double *dev_timeSlice_sigmaxx, double *dev_timeSlice_sigmazz, int its, int it2, int *dev_sourcesPositionRegCenterGrid, int nSourcesRegCenterGrid){
...
//STAGGERED GRIDs
__global__ void ker_inject_interp_source_stagGrid(double *dev_signalIn, double *dev_timeSlice, int its, int it2, int *dev_sourcesPositionRegGrid, int nSourcesRegGrid){
...
__global__ void ker_step_fwd_surface_top(double* dev_c_vx, double* dev_c_vz, double* dev_c_sigmaxx, double* dev_c_sigmazz, double* dev_c_sigmaxz){
...
__global__ void ker_step_adj_surface_top(double* dev_o_vx, double* dev_o_vz, double* dev_o_sigmaxx, double* dev_o_sigmazz, double* dev_o_sigmaxz,
     double* dev_c_vx, double* dev_c_vz, double* dev_c_sigmaxx, double* dev_c_sigmazz, double* dev_c_sigmaxz,
     double* dev_n_vx, double* dev_n_vz, double* dev_n_sigmaxx, double* dev_n_sigmazz, double* dev_n_sigmaxz,
     double* dev_rhoxDtw, double* dev_rhozDtw, double* dev_lamb2MuDtw, double* dev_lambDtw, double* dev_muxzDtw){
	     ...
	     __shared__ double shared_c_sigmazz_lambDtw[BLOCK_SIZE+2*FAT][BLOCK_SIZE+2*FAT]; // sigmazz*dtw*(lamb)
	     __shared__ double shared_c_sigmaxz_muxzDtw[BLOCK_SIZE+2*FAT][BLOCK_SIZE+2*FAT]; // sigmaxz*dtw*muxz
			 __shared__ double shared_c_sigmaxx_FreeSurfDtw[BLOCK_SIZE+2*FAT]; // sigmaxx*dtw*(lamb+2Mu + (lamb*lamb/(lamb+2Mu)))
...
__global__ void ker_step_adj_surface_body(double* dev_o_vx, double* dev_o_vz, double* dev_o_sigmaxx, double* dev_o_sigmazz, double* dev_o_sigmaxz,
     double* dev_c_vx, double* dev_c_vz, double* dev_c_sigmaxx, double* dev_c_sigmazz, double* dev_c_sigmaxz,
     double* dev_n_vx, double* dev_n_vz, double* dev_n_sigmaxx, double* dev_n_sigmazz, double* dev_n_sigmaxz,
     double* dev_rhoxDtw, double* dev_rhozDtw, double* dev_lamb2MuDtw, double* dev_lambDtw, double* dev_muxzDtw){
...
__global__ void dampCosineEdge_freesurface(double *dev_p1_vx, double *dev_p2_vx,
     double *dev_p1_vz, double *dev_p2_vz,
     double *dev_p1_sigmaxx, double *dev_p2_sigmaxx,
     double *dev_p1_sigmazz, double *dev_p2_sigmazz,
     double *dev_p1_sigmaxz, double *dev_p2_sigmaxz) {
...
__global__ void interpWavefieldSingleComp(double *dev_wavefield, double *dev_timeSlice, int its, int it2) {
...
__global__ void imagingElaAdjGpuStreams(double* dev_wavefieldVx_old, double* dev_wavefieldVx_cur, double* dev_wavefieldVx_new, double* dev_wavefieldVz_old, double* dev_wavefieldVz_cur, double* dev_wavefieldVz_new,
    double* dev_vx, double* dev_vz, double* dev_sigmaxx, double* dev_sigmazz, double* dev_sigmaxz, double* dev_drhox, double* dev_drhoz, double* dev_dlame, double* dev_dmu, double* dev_dmuxz, int its){
    //Index definition
    unsigned long long int izGlobal = FAT + blockIdx.x * BLOCK_SIZE + threadIdx.x; // Global z-coordinate
    unsigned long long int ixGlobal = FAT + blockIdx.y * BLOCK_SIZE + threadIdx.y; // Global x-coordinate
