...
nonlinearPropElasticShotsGpu::nonlinearPropElasticShotsGpu(std::shared_ptr<SEP::double3DReg> elasticParam,
...
void nonlinearPropElasticShotsGpu::adjointWavefield(const bool add, std::shared_ptr<double4DReg> model, const std::shared_ptr<double4DReg> data){
