...
__global__ void ker_we_fwd(double* dev_p0, double* dev_p1,
                             double* dev_rhox, double* dev_rhoz, double* dev_lamb2Mu, double* dev_lamb, double* dev_muxz,
...
__global__ void ker_we_adj(double* dev_p0, double* dev_p1,
                             double* dev_rhox, double* dev_rhoz, double* dev_lamb2Mu, double* dev_lamb, double* dev_muxz,
                             int absoluteFirstTimeSampleForBlock, int absoluteLastTimeSampleForBlock){
                             //double* dev_c_all,double* dev_n_all, double* dev_elastic_param_scaled) {
