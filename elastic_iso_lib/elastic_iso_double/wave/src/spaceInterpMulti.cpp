...
// Constructor #1
spaceInterpMulti::spaceInterpMulti(const std::shared_ptr<double1DReg> zCoord, const std::shared_ptr<double1DReg> xCoord, const std::shared_ptr<SEP::hypercube> elasticParamHypercube, int &nt, std::string interpMethod, int nFilt) {
...
void spaceInterpMulti::forward(const bool add, const std::shared_ptr<double3DReg> signalReg, std::shared_ptr<double3DReg> signalIrreg) const {
	...
	std::shared_ptr<double3D> d = signalIrreg->_mat;
	std::shared_ptr<double3D> m = signalReg->_mat;
...
void spaceInterpMulti::adjoint(const bool add, std::shared_ptr<double3DReg> signalReg, const std::shared_ptr<double3DReg> signalIrreg) const {
...
void spaceInterpMulti::checkOutOfBounds(const std::shared_ptr<double1DReg> zCoord, const std::shared_ptr<double1DReg> xCoord){
