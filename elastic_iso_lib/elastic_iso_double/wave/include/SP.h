...
*/
class SP : public Operator<double3DReg, double4DReg> {
    ...
    int _nw; //number of wavefields
		...
		std::shared_ptr<double4DReg> _tempWfld;
    ...
    */
		SP(const std::shared_ptr<double3DReg> model, const std::shared_ptr<double4DReg> data, std::vector<int> gridPointIndexUnique);
