...
*/
class waveEquationElasticGpu : public Operator<SEP::float4DReg, SEP::float4DReg> {
      ...
      */
  		waveEquationElasticGpu(const std::shared_ptr<float4DReg> model, const std::shared_ptr<float4DReg> data, std::shared_ptr<SEP::float3DReg> elasticParam, std::shared_ptr<paramObj> par);
