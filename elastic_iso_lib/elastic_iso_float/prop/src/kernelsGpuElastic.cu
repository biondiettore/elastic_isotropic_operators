...
__global__ void ker_step_fwd_surface_surface(float* dev_o_vx, float* dev_o_vz, float* dev_o_sigmaxx, float* dev_o_sigmazz, float* dev_o_sigmaxz,
     float* dev_c_vx, float* dev_c_vz, float* dev_c_sigmaxx, float* dev_c_sigmazz, float* dev_c_sigmaxz,
     float* dev_n_vx, float* dev_n_vz, float* dev_n_sigmaxx, float* dev_n_sigmazz, float* dev_n_sigmaxz,
     float* dev_rhoxDtw, float* dev_rhozDtw, float* dev_lamb2MuDtw, float* dev_lambDtw, float* dev_muxzDtw){
...
__global__ void ker_step_fwd_surface_body(float* dev_o_vx, float* dev_o_vz, float* dev_o_sigmaxx, float* dev_o_sigmazz, float* dev_o_sigmaxz,
    ...
    // Allocate shared memory for each wavefield component
    __shared__ float shared_c_vx[BLOCK_SIZE+2*FAT][BLOCK_SIZE+5+FAT]; // vx
    __shared__ float shared_c_vz[BLOCK_SIZE+2*FAT][BLOCK_SIZE+5+FAT]; // vz
    __shared__ float shared_c_sigmaxx[BLOCK_SIZE+2*FAT][BLOCK_SIZE+5+FAT]; // sigmaxx
    __shared__ float shared_c_sigmazz[BLOCK_SIZE+2*FAT][BLOCK_SIZE+5+FAT]; // sigmazz
    __shared__ float shared_c_sigmaxz[BLOCK_SIZE+2*FAT][BLOCK_SIZE+5+FAT]; // sigmaxz
...
__global__ void dampCosineEdge_surface_surface(float *dev_p1_vx, float *dev_p2_vx,
     float *dev_p1_vz, float *dev_p2_vz,
     float *dev_p1_sigmaxx, float *dev_p2_sigmaxx,
     float *dev_p1_sigmazz, float *dev_p2_sigmazz,
     float *dev_p1_sigmaxz, float *dev_p2_sigmaxz) {
...
__global__ void dampCosineEdge_surface_body(float *dev_p1_vx, float *dev_p2_vx,
     float *dev_p1_vz, float *dev_p2_vz,
     float *dev_p1_sigmaxx, float *dev_p2_sigmaxx,
     float *dev_p1_sigmazz, float *dev_p2_sigmazz,
     float *dev_p1_sigmaxz, float *dev_p2_sigmaxz) {
