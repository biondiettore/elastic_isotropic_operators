...
float **dev_wavefieldDts_left, **dev_wavefieldDts_right, **dev_pStream; //Left, right, and temp time slices for saving the wavefield using streams
float **pin_wavefieldSlice; //Pinnned memory to allow ansync memory copy
